...
const users = [
    new User('valentin', 'feldkircher', '3412788291', 'random@gmail.com', 'francia 954', 'a02b91bc-3769-4221-beb1-d7a3aeba7dad'),
];
...
app.post('/api/users', sanitizeUserInput, (req, res) => {
    ...
    const user = new User(input.nombre, input.apellido, input.tel, input.email, input.direccion);
    users.push(user);
